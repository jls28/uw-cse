...
{
public:
	virtual Vec3d shadowAttenuation(const Vec3d& P, double dx, double dy) const = 0;
	virtual double distanceAttenuation(const Vec3d& P, double dx, double dy) const = 0;
	virtual Vec3d getColor() const = 0;
	virtual Vec3d getDirection( const Vec3d& P, double dx, double dy ) const = 0;
...
public:
	...
	virtual Vec3d shadowAttenuation(const Vec3d& P, double dx, double dy) const;
	virtual double distanceAttenuation(const Vec3d& P, double dx, double dy) const;
	virtual Vec3d getColor() const;
	virtual Vec3d getDirection( const Vec3d& P, double dx, double dy ) const;
