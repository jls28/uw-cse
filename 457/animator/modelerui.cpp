		...
		{ // TODO: remove this extra brace!
			{ Fl_Group* o = m_viewPane = new Special_Tile(250, 25, 550, 600);
				...
				{ curvePane = new Fl_Group(250, 375, 550, 250);
					...
					{ particlePane = new Fl_Group(255, 575, 700, 20, "Particle System");
						// Put particle system label inside
						...
						// Snow button
						checkboxSnow = new Fl_Check_Button(450, 575, 75, 20, "Snow");
						checkboxSnow->callback((Fl_Callback*)checkboxSnowCallback);

						// Clear Particles button
						buttonClearParticles = new Fl_Button(510, 575, 50, 20, "Clear");
						buttonClearParticles->callback((Fl_Callback*)buttonClearParticlesCallback);

						// Particle "bake" indicator
						particleBakeIndicator = new IndicatorWindow(560, 575, 235, 20);
						// TODO: fix this:
...
void ModelerUserInterface::plotCamera() {
	if (m_modelerView->m_camera->getTarget() != NULL) {
...
void ModelerUserInterface::setSnow(bool snow) {
	ps->includeSnow = snow;
}
...
void ModelerUserInterface::checkboxSnowCallback(
	Fl_Check_Button* checkbox, void* v) {
	ModelerUserInterface::getInstance()->setSnow(
		checkbox->value() ? true : false);
}
