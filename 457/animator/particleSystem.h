...
public:
	...
	/** Simulation fxns **/
	virtual void setParticleOrigin(Vec3d origin);
	virtual void setParticleDirection(Vec3d direction);
	...
	RangeProperty restitutionSlider;
	RangeProperty dragSlider;
	RangeProperty gravSlider;
	boolean includeSnow;
	Texture2D texture;
	Vec3d collisionSpherePosition;
	double collisionSphereRadius;
...
protected:
	...
	int tick;
	double deltaT;
	Vec3d particle_origin;
	Vec3d particle_origin_prev;
	Vec3d particle_direction;
