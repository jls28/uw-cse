...
public class HW6TestDriver {
  ...
  private void listChildren(String graphName, String parentName) {
    Graph<String, String> g = graphs.get(graphName);
    String wazzup = "";
    for (Edge<String, String> e : g.getSortedEdges(parentName)) {
  ...
  private void loadGraph(String graphName, String fileName) {
    graphs.put(graphName, MarvelPaths.baseNameBuild(fileName));
  ...
  private void findPath(String graphName, String char1, String char2) {
    ...
    if (!g.contains(char1) || !g.contains(char2)) {
      ...
      List<Edge<String, String>> foundPath = MarvelPaths.findPath(g, char1, char2);
      ...
      if (foundPath == null) {
        ...
        for (Edge<String, String> e : foundPath) {
          output.println(parent + " to " + e.getDestination() + " via " + e.getData());
